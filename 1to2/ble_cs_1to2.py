...
class ble_cs_1to2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_reflector1_2m = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to2/data_reflector1_rx_from_initiator_2m', False)
        self.blocks_file_sink_reflector1_2m.set_unbuffered(False)
        self.blocks_file_sink_reflector2_2m = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to2/data_reflector2_rx_from_initiator_2m', False)
        self.blocks_file_sink_reflector2_2m.set_unbuffered(False)
        self.blocks_file_sink_initiator_2m = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to2/data_initiator_rx_from_reflectors_2m', False)
        self.blocks_file_sink_initiator_2m.set_unbuffered(False)
        self.blocks_file_sink_reflector1_4m = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to2/data_reflector1_rx_from_initiator_4m', False)
        self.blocks_file_sink_reflector1_4m.set_unbuffered(False)
        self.blocks_file_sink_reflector2_4m = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to2/data_reflector2_rx_from_initiator_4m', False)
        self.blocks_file_sink_reflector2_4m.set_unbuffered(False)
        self.blocks_file_sink_initiator_4m = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to2/data_initiator_rx_from_reflectors_4m', False)
        ...
        self.connect((self.analog_sig_source_x_0_1, 0), (self.blocks_multiply_conjugate_cc_0_1, 1))
