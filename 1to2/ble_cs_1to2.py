...
class ble_cs_1to2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.usrp_ble_random_phase_reflector2 = usrp_ble.random_phase(3, 1.0)
        self.usrp_ble_random_phase_reflector1 = usrp_ble.random_phase(2, 1.0)
        self.usrp_ble_random_phase_initiator = usrp_ble.random_phase(1, 1.0)
        ...
        self.usrp_ble_capture_gate_reflector2 = usrp_ble.capture_gate(1, 0, 2)
        self.usrp_ble_capture_gate_reflector1 = usrp_ble.capture_gate(1, 0, 2)
        self.usrp_ble_capture_gate_initiator = usrp_ble.capture_gate(1, 0, 2)
        ...
        self.msg_connect((self.usrp_ble_interact_center_0, 'capture_ctrl'), (self.usrp_ble_capture_gate_initiator, 'command'))
        self.msg_connect((self.usrp_ble_interact_center_0, 'capture_ctrl'), (self.usrp_ble_capture_gate_reflector1, 'command'))
        self.msg_connect((self.usrp_ble_interact_center_0, 'capture_ctrl'), (self.usrp_ble_capture_gate_reflector2, 'command'))
        ...
        self.msg_connect((self.usrp_ble_interact_center_0, 'freq_ctrl'), (self.usrp_ble_random_phase_initiator, 'freq'))
        self.msg_connect((self.usrp_ble_interact_center_0, 'freq_ctrl'), (self.usrp_ble_random_phase_reflector1, 'freq'))
        self.msg_connect((self.usrp_ble_interact_center_0, 'freq_ctrl'), (self.usrp_ble_random_phase_reflector2, 'freq'))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.usrp_ble_random_phase_initiator, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.usrp_ble_random_phase_reflector1, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.usrp_ble_random_phase_reflector2, 0))
        self.connect((self.blocks_multiply_conjugate_cc_0, 0), (self.usrp_ble_capture_gate_reflector1, 0))
        self.connect((self.blocks_multiply_conjugate_cc_0_0, 0), (self.usrp_ble_capture_gate_reflector2, 0))
        self.connect((self.blocks_multiply_conjugate_cc_0_1, 0), (self.usrp_ble_capture_gate_initiator, 0))
        ...
        self.connect((self.usrp_ble_capture_gate_initiator, 0), (self.blocks_file_sink_initiator_calibration, 0))
        self.connect((self.usrp_ble_capture_gate_initiator, 1), (self.blocks_file_sink_initiator_measurement, 0))
        self.connect((self.usrp_ble_capture_gate_reflector1, 0), (self.blocks_file_sink_reflector1_calibration, 0))
        self.connect((self.usrp_ble_capture_gate_reflector1, 1), (self.blocks_file_sink_reflector1_measurement, 0))
        self.connect((self.usrp_ble_capture_gate_reflector2, 0), (self.blocks_file_sink_reflector2_calibration, 0))
        self.connect((self.usrp_ble_capture_gate_reflector2, 1), (self.blocks_file_sink_reflector2_measurement, 0))
        ...
        self.connect((self.usrp_ble_random_phase_initiator, 0), (self.blocks_multiply_conjugate_cc_0_1, 1))
        self.connect((self.usrp_ble_random_phase_initiator, 0), (self.blocks_multiply_xx_0, 0))
        self.connect((self.usrp_ble_random_phase_reflector1, 0), (self.blocks_multiply_conjugate_cc_0, 1))
        self.connect((self.usrp_ble_random_phase_reflector1, 0), (self.blocks_multiply_xx_0_0, 0))
        self.connect((self.usrp_ble_random_phase_reflector2, 0), (self.blocks_multiply_conjugate_cc_0_0, 1))
        self.connect((self.usrp_ble_random_phase_reflector2, 0), (self.blocks_multiply_xx_0_1, 0))
