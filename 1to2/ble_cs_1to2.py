...
class ble_cs_1to2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.usrp_ble_data_store_0_0 = usrp_ble.data_store(200, 50000, '/home/mess1ah/zz_ble_cs_gnuradio/1to2/data_reflector2_rx_from_initiator')
        self.usrp_ble_data_store_0 = usrp_ble.data_store(200, 50000, '/home/mess1ah/zz_ble_cs_gnuradio/1to2/data_reflector1_rx_from_initiator')
        ...
        self.uhd_usrp_source_0 = uhd.usrp_source(
            ",".join(("addr=192.168.20.2", "recv_frame_size=1472")),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
