...
class ble_cs_1to1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.usrp_ble_data_store_0_1 = usrp_ble.data_store(200, 30000, '/home/mess1ah/zz_ble_cs_gnuradio/1to1/data_initiator_ref_local')
        self.usrp_ble_data_store_0_0_0 = usrp_ble.data_store(200, 30000, '/home/mess1ah/zz_ble_cs_gnuradio/1to1/data_reflector_ref_local')
        self.usrp_ble_data_store_0_0 = usrp_ble.data_store(200, 30000, '/home/mess1ah/zz_ble_cs_gnuradio/1to1/data_initiator_rx_from_reflector')
        self.usrp_ble_data_store_0 = usrp_ble.data_store(200, 30000, '/home/mess1ah/zz_ble_cs_gnuradio/1to1/data_reflector_rx_from_initiator')
        ...
        self.connect((self.analog_sig_source_x_0_1, 0), (self.usrp_ble_data_store_0_0_0, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.usrp_ble_data_store_0_1, 0))
