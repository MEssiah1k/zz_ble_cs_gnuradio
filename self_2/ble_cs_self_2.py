...
class ble_cs_self_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ble_cs_self_2")
        ...
        self.usrp_ble_data_store_0_2 = usrp_ble.data_store(200, 50000, '/home/lfy/workarea/zz_ble_cs_gnuradio/self_2/data_initiator_rx_from_reflectors')
        self.usrp_ble_data_store_0_1 = usrp_ble.data_store(200, 35000, '/home/lfy/workarea/zz_ble_cs_gnuradio/self_2/data_reflector1_rx_from_initiator')
        self.usrp_ble_data_store_0_0_0 = usrp_ble.data_store(200, 35000, '/home/lfy/workarea/zz_ble_cs_gnuradio/self_2/data_reflector2_rx_from_initiator')
        ...
        self.usrp_ble_channel_phase_r1_to_i = usrp_ble.channel_phase(centetr_fre, distance_m_1, 1.0)
        self.usrp_ble_channel_phase_i_to_r2 = usrp_ble.channel_phase(centetr_fre, distance_m_2, 1.0)
        self.usrp_ble_channel_phase_i_to_r1 = usrp_ble.channel_phase(centetr_fre, distance_m_1, 1.0)
        ...
        self.blocks_multiply_conjugate_cc_r2_rx = blocks.multiply_conjugate_cc(1)
        self.blocks_multiply_conjugate_cc_r1_rx = blocks.multiply_conjugate_cc(1)
        self.blocks_multiply_conjugate_cc_i_rx = blocks.multiply_conjugate_cc(1)
        ...
        self.msg_connect((self.usrp_ble_interact_center_0, 'freq_ctrl'), (self.usrp_ble_channel_phase_i_to_r1, 'freq'))
        self.msg_connect((self.usrp_ble_interact_center_0, 'freq_ctrl'), (self.usrp_ble_channel_phase_i_to_r2, 'freq'))
        self.msg_connect((self.usrp_ble_interact_center_0, 'freq_ctrl'), (self.usrp_ble_channel_phase_r1_to_i, 'freq'))
        self.msg_connect((self.usrp_ble_interact_center_0, 'freq_ctrl'), (self.usrp_ble_channel_phase_r2_to_i, 'freq'))
        ...
        self.msg_connect((self.usrp_ble_interact_center_0, 'store1_ctrl'), (self.usrp_ble_data_store_0_0_0, 'command'))
        self.msg_connect((self.usrp_ble_interact_center_0, 'store1_ctrl'), (self.usrp_ble_data_store_0_1, 'command'))
        self.msg_connect((self.usrp_ble_interact_center_0, 'store2_ctrl'), (self.usrp_ble_data_store_0_2, 'command'))
        ...
        self.connect((self.blocks_add_xx_reflectors_at_initiator, 0), (self.blocks_multiply_conjugate_cc_i_rx, 0))
    ...
    def get_distance_m_2(self):
        return self.distance_m_2

    def set_distance_m_2(self, distance_m_2):
        self.distance_m_2 = distance_m_2
        self.usrp_ble_channel_phase_i_to_r2.set_distance_m(self.distance_m_2)
        self.usrp_ble_channel_phase_r2_to_i.set_distance_m(self.distance_m_2)

    def get_distance_m_1(self):
        return self.distance_m_1

    def set_distance_m_1(self, distance_m_1):
        self.distance_m_1 = distance_m_1
        self.usrp_ble_channel_phase_i_to_r1.set_distance_m(self.distance_m_1)
        self.usrp_ble_channel_phase_r1_to_i.set_distance_m(self.distance_m_1)
    ...
    def set_centetr_fre(self, centetr_fre):
        ...
        self.usrp_ble_channel_phase_i_to_r1.set_center_freq_hz(self.centetr_fre)
        self.usrp_ble_channel_phase_i_to_r2.set_center_freq_hz(self.centetr_fre)
        self.usrp_ble_channel_phase_r1_to_i.set_center_freq_hz(self.centetr_fre)
        self.usrp_ble_channel_phase_r2_to_i.set_center_freq_hz(self.centetr_fre)




def main(top_block_cls=ble_cs_self_2, options=None):
