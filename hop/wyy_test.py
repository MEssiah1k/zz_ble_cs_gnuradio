...
class wyy_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "wyy_test")
        ...
        self.usrp_ble_data_store_0_0 = usrp_ble.data_store(10000000, '/home/mess1ah/zz_ble_cs_gnuradio/cs_gnuradio/data_store_1')
        self.usrp_ble_data_store_0 = usrp_ble.data_store(10000000, '/home/mess1ah/zz_ble_cs_gnuradio/cs_gnuradio/data_store_2')
...
def main(top_block_cls=wyy_test, options=None):
