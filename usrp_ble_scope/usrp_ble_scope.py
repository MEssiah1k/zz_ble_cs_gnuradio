...
# Title: USRP BLE CS Scope
# Author: lfy
# Description: USRP scope capture for BLE Channel Sounding IQ
...
class usrp_ble_scope(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "USRP BLE CS Scope", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("USRP BLE CS Scope")
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_ble_scope")
        ...
        self.capture_seconds = capture_seconds = 0.1
        self.recv_gain = recv_gain = 20
        ...
        self._recv_gain_range = Range(0, 40, 1, 20, 200)
        ...
        labels = ['|IQ|', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
...
def main(top_block_cls=usrp_ble_scope, options=None):
