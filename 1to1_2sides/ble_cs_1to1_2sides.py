...
class ble_cs_1to1_2sides(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.usrp_ble_interact_center_0 = usrp_ble.interact_center(int(samp_rate), start_button, stop_button, wait_time_ms, repeat_total, start_freq_index, stop_freq_index, step_hz, 2, 0.0)
