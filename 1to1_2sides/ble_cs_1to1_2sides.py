...
class ble_cs_1to1_2sides(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.wait_time_ms = wait_time_ms = 10
        ...
        self.usrp_ble_interact_center_0 = usrp_ble.interact_center(int(samp_rate), start_button, stop_button, wait_time_ms, repeat_total, start_freq_index, stop_freq_index, step_hz, groups)
        ...
        self.usrp_ble_capture_gate_0_0 = usrp_ble.capture_gate(1, 0, 9)
        self.usrp_ble_capture_gate_0 = usrp_ble.capture_gate(1, 0, groups)
        ...
        self.blocks_file_sink_1_9 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_reflector_rx_from_initiator_measurement7', False)
        self.blocks_file_sink_1_9.set_unbuffered(False)
        self.blocks_file_sink_1_8 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_reflector_rx_from_initiator_measurement8', False)
        self.blocks_file_sink_1_8.set_unbuffered(False)
        self.blocks_file_sink_1_7 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_reflector_rx_from_initiator_measurement6', False)
        self.blocks_file_sink_1_7.set_unbuffered(False)
        self.blocks_file_sink_1_6 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_reflector_rx_from_initiator_measurement5', False)
        self.blocks_file_sink_1_6.set_unbuffered(False)
        self.blocks_file_sink_1_3 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_reflector_rx_from_initiator_measurement4', False)
        self.blocks_file_sink_1_3.set_unbuffered(False)
        self.blocks_file_sink_1_2 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_reflector_rx_from_initiator_measurement3', False)
        self.blocks_file_sink_1_2.set_unbuffered(False)
        self.blocks_file_sink_1_1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_reflector_rx_from_initiator_measurement2', False)
        self.blocks_file_sink_1_1.set_unbuffered(False)
        self.blocks_file_sink_1_0_6 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_initiator_rx_from_reflector_measurement7', False)
        self.blocks_file_sink_1_0_6.set_unbuffered(False)
        self.blocks_file_sink_1_0_5 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_initiator_rx_from_reflector_measurement8', False)
        self.blocks_file_sink_1_0_5.set_unbuffered(False)
        self.blocks_file_sink_1_0_4 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_initiator_rx_from_reflector_measurement6', False)
        self.blocks_file_sink_1_0_4.set_unbuffered(False)
        self.blocks_file_sink_1_0_3 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_initiator_rx_from_reflector_measurement5', False)
        self.blocks_file_sink_1_0_3.set_unbuffered(False)
        self.blocks_file_sink_1_0_2 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_initiator_rx_from_reflector_measurement4', False)
        self.blocks_file_sink_1_0_2.set_unbuffered(False)
        self.blocks_file_sink_1_0_1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_initiator_rx_from_reflector_measurement3', False)
        self.blocks_file_sink_1_0_1.set_unbuffered(False)
        self.blocks_file_sink_1_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lfy/workarea/zz_ble_cs_gnuradio/1to1_2sides/data_initiator_rx_from_reflector_measurement2', False)
        ...
        self.connect((self.usrp_ble_capture_gate_0, 1), (self.blocks_file_sink_1, 0))
        self.connect((self.usrp_ble_capture_gate_0, 2), (self.blocks_file_sink_1_1, 0))
        self.connect((self.usrp_ble_capture_gate_0, 3), (self.blocks_file_sink_1_2, 0))
        self.connect((self.usrp_ble_capture_gate_0, 4), (self.blocks_file_sink_1_3, 0))
        self.connect((self.usrp_ble_capture_gate_0, 5), (self.blocks_file_sink_1_6, 0))
        self.connect((self.usrp_ble_capture_gate_0, 6), (self.blocks_file_sink_1_7, 0))
        self.connect((self.usrp_ble_capture_gate_0, 8), (self.blocks_file_sink_1_8, 0))
        self.connect((self.usrp_ble_capture_gate_0, 7), (self.blocks_file_sink_1_9, 0))
        self.connect((self.usrp_ble_capture_gate_0_0, 0), (self.blocks_file_sink_0_0, 0))
        self.connect((self.usrp_ble_capture_gate_0_0, 1), (self.blocks_file_sink_1_0, 0))
        self.connect((self.usrp_ble_capture_gate_0_0, 2), (self.blocks_file_sink_1_0_0, 0))
        self.connect((self.usrp_ble_capture_gate_0_0, 3), (self.blocks_file_sink_1_0_1, 0))
        self.connect((self.usrp_ble_capture_gate_0_0, 4), (self.blocks_file_sink_1_0_2, 0))
        self.connect((self.usrp_ble_capture_gate_0_0, 5), (self.blocks_file_sink_1_0_3, 0))
        self.connect((self.usrp_ble_capture_gate_0_0, 6), (self.blocks_file_sink_1_0_4, 0))
        self.connect((self.usrp_ble_capture_gate_0_0, 8), (self.blocks_file_sink_1_0_5, 0))
        self.connect((self.usrp_ble_capture_gate_0_0, 7), (self.blocks_file_sink_1_0_6, 0))
    ...
    def set_groups(self, groups):
        self.groups = groups
        self.usrp_ble_interact_center_0.set_capture_groups(self.groups)
